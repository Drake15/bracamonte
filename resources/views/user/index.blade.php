                            ...
                            <tbody>
                               ...
                               @foreach($usuarios as $user)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-md" data-id_usuario="{{$user->id}}" data-nombre="{{$user->nombre}}" data-apellido="{{$user->apellido}}" data-direccion="{{$user->direccion}}" data-telefono="{{$user->telefono}}" data-id_rol="{{$user->idrol}}"  data-usuario="{{$user->usuario}}"   data-toggle="modal" data-target="#abrirmodalEditar">
